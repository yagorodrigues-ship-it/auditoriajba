...
# --- TELA LOGADA DO SISTEMA ---
            ...
            if codigo_input:
                ...
                if not item_autorizado:
                    ...
                    if not itens_filtrados.empty:
                        ...
                        # --- SOLUÇÃO CRÍTICA DEFINITIVA PARA ATTRIBUTE_ERROR ---
                        # Evita falhas verificando explicitamente se a coluna 'ativo' existe no retorno do banco
                        ...
                        if ativo_bipado_direto:
                            ...
                            item_especifico = líneas_filtradas_por_lote = linhas_filtradas_por_lote[linhas_filtradas_por_lote[col_orig_ativo].astype(str).str.strip() == ativo_selecionado].iloc[0]
                        else:
    ...
    with aba_supervisor:
        ...
        if not eh_supervisor:
            ...
            if inv_sup_selected_obj is not None and inv_sup_selected_obj['status'] == "Aberto":
            ...
            if id_inv_sup_atual and inv_sup_selected_obj['status'] == "Aberto" and st.session_state.base_supervisor is not None:
